const APP_CONFIG = {
    ...
    appName: "IQO",
    version: "Final.Source.100",
    imgPath: "./assets/"
};

const EXAM_DATA = [
    {
        id: "thpt-hoa-338-full",
        category: "thpt",
        title: "Đề thi THPT QG môn Hóa Học 2025",
        subtitle: "Mã đề 0338 • Sao y bản chính",
        time: 50,
        questions: [
            { 
                id: 1, type: "choice", 
            ...
            { 
                id: 32, type: "input", 
                text: "Luyện thép từ gang là quá trình làm giảm hàm lượng carbon và một số nguyên tố khác có trong gang. Một nhà máy luyện thép sử dụng loại gang nguyên liệu trong đó carbon chiếm 4,60% về khối lượng, còn lại là iron (coi hàm lượng các nguyên tố khác không đáng kể). Khi tiến hành luyện thép, một lượng 2,88 tấn khí oxygen được thổi vào 45,0 tấn gang nguyên liệu nóng chảy để oxi hóa carbon thành CO và CO<sub>2</sub>. Hỗn hợp khí thu được chỉ gồm CO và CO<sub>2</sub> có số mol bằng nhau. Phần trăm khối lượng carbon trong thép thu được là w%, còn lại là iron. Coi iron không bị mất đi trong quá trình luyện thép. Giá trị của w là bao nhiêu? (Không làm tròn kết quả các phép tính trung gian, chỉ làm tròn kết quả cuối cùng đến hàng phần trăm.)", 
                placeholder: "Nhập câu trả lời..." 
            },
            { 
                id: 33, type: "input", 
